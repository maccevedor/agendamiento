...
//Sede 
$servicio="";
if(is_numeric($datos[0]['servicio_id'])){
	$term = taxonomy_term_load($datos[0]['servicio_id']);//									
	$servicio=$term->name;
	$recomendacion="";
	if(isset($term->field_agreno[LANGUAGE_NONE])){
		$recomendacion=$term->field_agreno[LANGUAGE_NONE][0]["value"];
	}
}
                                                            ...
                                                            <table align="Left" border="0" cellpadding="0" cellspacing="0" width="260" style="border-collapse:collapse">
                                                                <tbody><tr>
                                                                    <td valign="bottom" style="color:#444;font-weight:600;letter-spacing:-1px;vertical-align:bottom;text-align:left">
                                                                        <h3 style="margin:0;padding:0;color:#53585f;font-family:Helvetica;font-size:25px;line-height:100%;text-align:left"><span class="il"><?php echo $servicio;?></span> agendamiento</h3>
                                                                    </td>
                                                                </tr>
                                                            </tbody></table>
                                                        </td>
                                                            ...
                                                            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="border-collapse:collapse">
                                                                <tbody><tr>
                                                                    <td valign="top" style="color:#404040;font-family:Helvetica;font-size:16px;line-height:125%;text-align:left;padding-bottom:20px">
																		...
																		<p style="margin:1em 0;color:#53585f;font-family:Helvetica;text-align:left"><strong><?php echo utf8_decode($datos[0]['nombre']);?>&nbsp;<?php echo utf8_decode($datos[0]['apellido']);?></strong> acaba de solicitar una cita con el especialista <strong><?php echo utf8_decode($especialista);?></strong>.</p>
                                ...
                                <td align="center" valign="top">
                                  <table border="0" cellpadding="10" cellspacing="0" width="95%" style="border-collapse:collapse;background-color:#ffffff;border:1px solid #dddddd;border-top:none;border-left:none;border-right:none;border-bottom:none;padding-top:130px">
                                      ...
                                      <tr>
                                          ...
                                          <td valign="top" style="border-top:1px solid #dddddd;border-bottom:0;color:#53585f;font-family:Helvetica;font-size:12px;font-weight:400;line-height:150%;text-align:left">
												<?php echo utf8_decode($datos[0]['nombre']);?>&nbsp;<?php echo utf8_decode($datos[0]['apellido']);?>
                                          </td>
                                      </tr>
									  <tr>
									  ...
									  <tr>
									    ...
									    <td valign="top" style="border-top:1px solid #dddddd;border-bottom:0;color:#53585f;font-family:Helvetica;font-size:12px;font-weight:400;line-height:150%;text-align:left"><?php echo utf8_decode($ciudad_cita);?> - <?php echo utf8_decode($depto_cita);?> - <?php echo utf8_decode($pais_cita);?></td>
									    </tr>
									  <tr>
									    ...
									    <td valign="top" style="border-top:1px solid #dddddd;border-bottom:0;color:#53585f;font-family:Helvetica;font-size:12px;font-weight:400;line-height:150%;text-align:left"><?php echo utf8_decode($sede);?></td>
									    </tr>
									  <tr>
									    ...
									    <td valign="top" style="border-top:1px solid #dddddd;border-bottom:0;color:#53585f;font-family:Helvetica;font-size:12px;font-weight:400;line-height:150%;text-align:left"><?php echo utf8_decode($datos[0]['direccion']);?></td>
									    </tr>
									  <tr>
									  ...
									  <tr>
									    <td valign="top" style="border-top:1px solid #dddddd;border-bottom:0;color:#53585f;font-family:Helvetica;font-size:12px;font-weight:400;line-height:150%;text-align:left">Fecha y hora inicio:</td>
									  ...
									  <tr>
									    <td valign="top" style="border-top:1px solid #dddddd;border-bottom:0;color:#53585f;font-family:Helvetica;font-size:12px;font-weight:400;line-height:150%;text-align:left">Fecha y hora fin:</td>
									    <td valign="top" style="border-top:1px solid #dddddd;border-bottom:0;color:#53585f;font-family:Helvetica;font-size:12px;font-weight:400;line-height:150%;text-align:left"><?php echo $datos[0]['fecha_final'];?></td>
									    </tr>
									  <tr>
									    ...
									    <td valign="top" style="border-top:1px solid #dddddd;border-bottom:0;color:#53585f;font-family:Helvetica;font-size:12px;font-weight:400;line-height:150%;text-align:left"><?php echo utf8_decode($medio_atencion);?></td>
									    </tr>
									  <tr>
									    <td valign="top" style="border-top:1px solid #dddddd;border-bottom:0;color:#53585f;font-family:Helvetica;font-size:12px;font-weight:400;line-height:150%;text-align:left">Motivo cita:</td>
									    <td valign="top" style="border-top:1px solid #dddddd;border-bottom:0;color:#53585f;font-family:Helvetica;font-size:12px;font-weight:400;line-height:150%;text-align:left"><?php echo utf8_decode($motivo_cita);?></td>
									    </tr>
									  <tr>
									    ...
									    <td valign="top" style="border-top:1px solid #dddddd;border-bottom:0;color:#53585f;font-family:Helvetica;font-size:12px;font-weight:400;line-height:150%;text-align:left"><?php echo utf8_decode($datos[0]['asunto']);?></td>
									    </tr>
									  <tr>
                                          <td valign="top" style="border-top:1px solid #dddddd;border-bottom:0;color:#53585f;font-family:Helvetica;font-size:12px;font-weight:400;line-height:150%;text-align:left">
                                              Notas:
                                          </td>
                                          <td valign="top" style="border-top:1px solid #dddddd;border-bottom:0;color:#53585f;font-family:Helvetica;font-size:12px;font-weight:400;line-height:150%;text-align:left"><?php echo utf8_decode($datos[0]['descripcion']);?>
                                                    ...
                                                    <tbody><tr>
                                                      <td align="center" valign="middle" style="padding-top:20px;padding-right:20px;padding-left:20px">
                                                          <div style="font-size:12px">
                                                            <p style="margin:1em 0;color:#53585f;font-family:Helvetica;text-align:justify"> <?php echo utf8_decode($recomendacion);?></p>
                                                          </div>
                                                        </td>
                                                    </tr>   
                                                </tbody></table>
