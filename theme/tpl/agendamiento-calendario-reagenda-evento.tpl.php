    		...
    		<div class="container-fluid">
                ...
                <ul class="nav nav-tabs">
                  <li role="presentation"><a href="<?php echo $base_url;?>/agendamiento/calendario">Calendario</a></li>
                    <?php if(user_access("adicionar evento")){?>
                  		<li role="presentation"><a href="<?php echo $base_url;?>/agendamiento/calendario/nuevo"><?php echo $textos["nuevo_evento"]?></a></li>
                	<?php }?>
                   <?php if(user_access("reagendar evento")){?> 
                   		<li role="presentation" class="active"><a href="<?php echo $base_url;?>/agendamiento/calendario/reagendar"><?php echo $textos["reagendar_evento"]?></a></li>
                	  <?php }?>	
                </ul>
                ...
                <div class="wrapper-form">
                    ...
                    <div class="alert alert-info" role="alert">
                         ...
                         <ul>
                         		<li>Sede (Siempre y cuando la asignacion de especialista sea manual)</li>
                             <li>Especialista (Siempre y cuando la asignacion de especialista sea manual)</li>
                             <li>Fecha y Hora</li>
                    ...
                    <!-- Fila 4 -->
                    <div class="row"> 
                            <div class="col-xs-12 col-sm-12 col-md-12"><?php print drupal_render($form["datos_evento"]["asunto"]);?></div>
                    ...
                    <div class="row">
                    		<div class="col-xs-12 col-sm-12 col-md-12">
                            	<div class="pull-right">
                            		<input type="hidden" id="agendamiento_id" name="agendamiento_id" value="0">
		...
		(function($){
			...
			var mostrarDependenciasEspecialista=function(){
			 ...
			 var enviarInformacion=function(){
				...
				var datastring = $("#agendamiento-node-form").serialize(); 
				jQuery.ajax({
					url: Drupal.settings.base_url +'/agendamiento/calendario/reagendar/guardar',
					data: datastring,
					type: 'POST',
					dataType: 'json',
					success: function(data){																	
			...
			if(DSA.hora_exacta==1){
				$("#agendamiento_id").val(DSA.agendamiento_id_exacta);
				...
				$("#edit-asunto").val(DSA.asunto_exacta);$("#edit-asunto").prop('readonly', true);
				
				$("#edit-numero-documento").val(DSA.numero_documento_exacta);
				$("#edit-tipo-documento").val(DSA.tipo_documento_exacta);
				$("#edit-nombres-cliente").val(DSA.nombres_cliente_exacta);
				$("#edit-apellidos-cliente").val(DSA.apellidos_cliente_exacta);
				$("#edit-telefono-fijo").val(DSA.telefono_fijo_exacta);
				$("#edit-extension-fijo").val(DSA.extension_fijo_exacta);
				$("#edit-telefono-celular").val(DSA.telefono_celular_exacta);
				$("#edit-fecha-nacimiento").val(DSA.fecha_nacimiento_exacta);
				$("#edit-correo-electronico").val(DSA.correo_electronico_exacta);
				$("#edit-pais-cliente").val(DSA.pais_cliente_exacta);$("#edit-pais-cliente").change();
			    $("#edit-direccion").val(DSA.direccion_exacta);
				
				
				
				$(".wrapper-cliente input,.wrapper-cliente select").each(function(){
				...
				$('#edit-fecha-hasta').data('DateTimePicker').date(moment(DSA.fecha_hora_exacta,"MM/DD/YYYY hh:mm").add(DSA.tiempo_evento,'m'));
			}		
			...
			$("#edit-ciudad").change(function(){
				...
				if(DSA.hora_exacta==1 && DSA.asignacion_especialista!="manual"){
			...
			$("#edit-pais-cliente").change(function(){
				...
				if($("#edit-depto-cliente option").length==2){
					seleccionarDefault("#edit-depto-cliente");
				       ...
				       //en este caso, se seleccionara esa opcion en especial 
					if(DSA.hora_exacta==1){
						$("#edit-depto-cliente").val(DSA.depto_cliente_exacta);$("#edit-depto-cliente").change();  
					}	
				}
			});
			...
			$("#edit-depto-cliente").change(function(){
				...
				if($("#edit-ciudad-cliente option").length==2){
					seleccionarDefault("#edit-ciudad-cliente");
				       ...
				       //en este caso, se seleccionara esa opcion en especial 
					if(DSA.hora_exacta==1){
						$("#edit-ciudad-cliente").val(DSA.ciudad_cliente_exacta); 
					}	
				}
			});
